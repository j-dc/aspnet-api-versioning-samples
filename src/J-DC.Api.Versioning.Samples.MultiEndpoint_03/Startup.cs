...
namespace JDC.Api.Versioning.Samples.MultiEndpoint_03 {
    class Startup {
        ...
        public void Configuration(IAppBuilder builder) {
            ...
            configuration.MapVersionedODataRoutes("odata-data-v1", "data/v1", models, ConfigureContainer);
            ...
            configuration.MapVersionedODataRoutes("odata-data-v2", "data/v2", models, ConfigureContainer);
            ...
            models = modelBuilder.GetEdmModels();
            configuration.MapVersionedODataRoutes("odata-config-v11", "config/v11", models, ConfigureContainer);
            ...
            models = modelBuilder.GetEdmModels();
            configuration.MapVersionedODataRoutes("odata-config-v12", "config/v12", models, ConfigureContainer);
